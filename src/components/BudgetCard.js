    ...
    return (
        <Card className={classNames.join(" ")}>
            <Card.Body>
                ...
                {max && (
                    //"max" is used to hide the "progressBar" of "Uncategorized"
                ...
                /> 
                  ...
                  {/*Coming straight from Bootstrap and its InBuilt "ProgressBar"
                   */}
     
            {! hideButtons && (<Stack direction="horizontal" gap="2" className="mt-4">
                {/* This condition comes true if "hideButtons" is present */}
                <Button variant="outline-primary" className='ms-auto'onClick=
                {onAddExpenseClick}>
                      Add Expenses
                </Button>
